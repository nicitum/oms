...
import { View, Text, TextInput, FlatList, Button, StyleSheet, TouchableOpacity, ActivityIndicator, Alert, KeyboardAvoidingView, Platform } from 'react-native';
...
const UpdateOrdersU = () => {
    ...
    const renderOrderItem = ({ item }) => (
        ...
        >
            <View style={styles.orderCardContent}>
                ...
                <Text style={styles.orderSubText}>₹{item.total_amount ? parseFloat(item.total_amount).toFixed(2) : '0.00'}</Text>
                <Text style={styles.orderSubText}>{item.cancelled === 'Yes' ? 'Cancelled' : 'Active'}</Text>
                <TouchableOpacity
    ...
    return (
        ...
        >
            ...
            {loading && <ActivityIndicator size="large" color="#003366" style={styles.loading} />}
            ...
            <FlatList
                ...
                ListEmptyComponent={<Text style={styles.emptyText}>No orders found for today</Text>}
            ...
            {selectedOrderId && !isOrderUpdated && (
                <View style={styles.orderDetails}>
                    <View style={styles.orderDetailsHeader}>
                        <Text style={styles.orderDetailsTitle}>Order #{selectedOrderId}</Text>
